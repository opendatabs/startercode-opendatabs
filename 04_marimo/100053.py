# 100053 — marimo starter (Polars)
# Run:  marimo run 04_marimo/100053.py   (or: marimo edit ...)
...
DATASHOP_MD_LINK = """[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100053)"""
...
def _():
    # Read the dataset
    df = get_dataset('https://data.bs.ch/explore/dataset/100053/download')
