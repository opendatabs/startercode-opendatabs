...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100317**
    """
    )
    return
...
Basel-Stadt nach Geschlecht, Jahrgang und Beruf sowie die jeweiligen Listen.<o:p></o:p></span></p><p style="font-family: sans-serif;">
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100317)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100317")
    df
    return (df,)
