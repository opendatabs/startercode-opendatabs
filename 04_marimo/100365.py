...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100365**
    """
    )
    return
...
Online-Archivkatalog, Verpacken, Etikettieren und Magazinieren.</p>
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100365)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100365")
    df
    return (df,)
