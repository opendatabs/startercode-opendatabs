...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100488**
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Dataset
    # **Resultate der Einwohnerratswahlen in Riehen 2025**
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100488)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100488")
    df
    return (df,)
