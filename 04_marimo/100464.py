...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100464**
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Dataset
    # **Informationen für den Raum St. Jakob**
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100464)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100464")
    df
    return (df,)
