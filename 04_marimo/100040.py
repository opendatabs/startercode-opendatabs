...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100040**
    """
    )
    return
...
- Beispiel Block rund um die Clarakirche: BLO_ID 121014, die Bezeichnung (BLO_Label) lautet 12.1.014
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100040)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100040")
    df
    return (df,)
