...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100406**
    """
    )
    return
...
Open Data Basel-Stadt erstellt und pflegt diese Dashboards, um öffentlich relevante Daten benutzerfreundlich und transparent zu präsentieren.</p>
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100406)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100406")
    df
    return (df,)
