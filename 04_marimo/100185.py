...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100185**
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Dataset
    # **Befragung 55plus (jahresübergreifend)**
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100185)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100185")
    df
    return (df,)
