...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100252**
    """
    )
    return
...
Weitere Daten zu "Verkehrsberuhigte Zonen": <a href="https://data.bs.ch/explore/?refine.tags=Verkehrsberuhigte+Zonen">https://data.bs.ch/explore/?refine.tags=Verkehrsberuhigte+Zonen</a>
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100252)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100252")
    df
    return (df,)
