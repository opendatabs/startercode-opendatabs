...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100429**
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Dataset
    # **Anreiseempfehlungen für Veranstaltungen im Raum St. Jakob**
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100429)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100429")
    df
    return (df,)
