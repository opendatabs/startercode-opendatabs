...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100102**
    """
    )
    return
...
Schlussresultate im Kantonsblatt des Kantons Basel-Stadt publiziert werden.<o:p></o:p></p>
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100102)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100102")
    df
    return (df,)
