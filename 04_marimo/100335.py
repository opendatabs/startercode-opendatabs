...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100335**
    """
    )
    return
...
Diese Daten werden vom Tiefbauamt des Kantons Basel-Stadt zur Verfügung gestellt. Die Baustellen finden Sie auch auf einer interaktiven Karte unter <a href="https://baustellen.bs.ch" target="_blank">https://baustellen.bs.ch</a>. </p><p></p><p></p>
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100335)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100335")
    df
    return (df,)
