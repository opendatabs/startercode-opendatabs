...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100089**
    """
    )
    return
...
<p>Der Pegel wird berechnet als [Wasserstand] - 240 m ü. M., siehe <a href="https://port-of-switzerland.ch/hafenservice/pegel/" target="_blank">https://port-of-switzerland.ch/hafenservice/pegel</a>. </p>
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100089)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100089")
    df
    return (df,)
