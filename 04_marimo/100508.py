...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100508**
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Dataset
    # **Angezeigte Straftaten nach Strafgesetzbuch (StGB)**
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100508)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100508")
    df
    return (df,)
