...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100419**
    """
    )
    return
...
Datengrundlage für die Planungsstellen in den Kantonen BS und BL.<o:p></o:p></p>
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100419)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100419")
    df
    return (df,)
