# 100283 — marimo starter (Polars)
# Run:  marimo run 04_marimo/100283.py   (or: marimo edit ...)
...
DATASHOP_MD_LINK = """[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100283)"""
