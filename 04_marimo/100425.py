...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100425**
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Dataset
    # **Bewilligungen für Nacht-, Sonn- und/oder Feiertagsarbeit**
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100425)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100425")
    df
    return (df,)
