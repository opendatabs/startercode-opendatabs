...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100519**
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Dataset
    # **Anzahl durch Wärmepumpen beheizte Gebäude**
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100519)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100519")
    df
    return (df,)
