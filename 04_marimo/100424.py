...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100424**
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Dataset
    # **Bewilligungen gemäss dem baselstädtischen Gesetz über öffentliche Ruhetage und Ladenöffnung**
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100424)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100424")
    df
    return (df,)
