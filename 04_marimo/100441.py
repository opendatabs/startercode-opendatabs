...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100441**
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Dataset
    # **Straftaten nach Ausländer- und Integrationsgesetz (AIG)**
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100441)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100441")
    df
    return (df,)
