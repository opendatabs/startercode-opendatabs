...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100150**
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Dataset
    # **Jahresübersicht Open-Data-Kennzahlen**
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100150)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100150")
    df
    return (df,)
