# 100084 — marimo starter (Polars)
# Run:  marimo run 04_marimo/100084.py   (or: marimo edit ...)
...
DATASHOP_MD_LINK = """[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100084)"""
...
def _():
    # Read the dataset
    df = get_dataset('https://data.bs.ch/explore/dataset/100084/download')
