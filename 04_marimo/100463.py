...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **100463**
    """
    )
    return
...
def _(mo):
    ...
    *You can find the dataset [under this link](https://data.bs.ch/explore/dataset/100463)*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="100463")
    df
    return (df,)
