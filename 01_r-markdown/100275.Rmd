...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100275)

Auto generated R starter code for data set 100275.
...
- **Issued** `2023-10-09`
- **Modified** `2026-02-06T20:00:11+00:00`
- **Rights** `NonCommercialAllowed-CommercialAllowed-ReferenceRequired`
- **Temporal_coverage_start_date** `2023-04-22T22:00:00+00:00`
- **Temporal_coverage_end_date** `2026-02-04T23:00:00+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100275.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100275/download?format=csv&timezone=Europe%2FZurich')
