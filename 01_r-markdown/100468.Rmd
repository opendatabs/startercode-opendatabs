...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100468)

Auto generated R starter code for data set 100468.
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100468.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100468/download?format=csv&timezone=Europe%2FZurich')
