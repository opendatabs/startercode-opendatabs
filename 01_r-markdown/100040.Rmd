...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100040)

Auto generated R starter code for data set 100040.
...
- **Issued** `2019-11-06`
- **Modified** `2024-07-05T05:03:23+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100040.csv')
