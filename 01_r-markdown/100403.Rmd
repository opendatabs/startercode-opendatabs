...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100403)

Auto generated R starter code for data set 100403.
...
- **Issued** `2024-12-20`
- **Modified** `2025-04-28T07:47:52+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100403.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100403/download?format=csv&timezone=Europe%2FZurich')
