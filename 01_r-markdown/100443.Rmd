...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100443)

Auto generated R starter code for data set 100443.
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100443.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100443/download?format=csv&timezone=Europe%2FZurich')
