...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100335)

Auto generated R starter code for data set 100335.
...
- **Issued** `2024-07-05`
- **Modified** `2024-07-05T06:02:13+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100335.csv')
