...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100416)

Auto generated R starter code for data set 100416.
...
- **Issued** `2025-05-12`
- **Modified** `2025-09-17T04:02:26+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100416.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100416/download?format=csv&timezone=Europe%2FZurich')
