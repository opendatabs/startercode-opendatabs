...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100313)

Auto generated R starter code for data set 100313.
...
- **Issued** `2023-09-29`
- **Modified** `2024-07-04T08:03:51+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100313.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100313/download?format=csv&timezone=Europe%2FZurich')
