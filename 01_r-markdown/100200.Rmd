...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100200)

Auto generated R starter code for data set 100200.

## Metadata

- **Dataset_identifier** `100200`
- **Title** `Geschwindigkeitsmonitoring: Einzelmessungen bis 2020`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100200.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100200/download?format=csv&timezone=Europe%2FZurich')
