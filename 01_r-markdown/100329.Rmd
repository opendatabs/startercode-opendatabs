...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100329)

Auto generated R starter code for data set 100329.
...
- **Issued** `2024-07-10`
- **Modified** `2025-12-22T00:01:30+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100329.csv')
