...
## Dataset: Angezeigte Straftaten nach Betäubungsmittelgesetz (BetmG)

[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100449)

Auto generated R starter code for data set 100449.
...
- **Issued** `2026-03-24`
- **Modified** `2026-03-23T15:45:36+00:00`
...
- **Keywords** `['PKS', 'Kriminalstatistik', 'Betäubungsmittel', 'Polizei']`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100449.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100449/download?format=csv&timezone=Europe%2FZurich')
