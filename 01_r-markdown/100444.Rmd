...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100444)

Auto generated R starter code for data set 100444.
...
- **Issued** `2025-05-27`
- **Modified** `2026-02-11T15:01:29+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100444.csv')
