...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100391)

Auto generated R starter code for data set 100391.
...
- **Issued** `2024-08-26`
- **Modified** `2025-04-28T07:47:49+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100391.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100391/download?format=csv&timezone=Europe%2FZurich')
