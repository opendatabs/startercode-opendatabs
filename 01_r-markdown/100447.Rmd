...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100447)

Auto generated R starter code for data set 100447.
...
- **Issued** `2025-05-27`
- **Modified** `2025-12-08T15:01:22+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100447.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100447/download?format=csv&timezone=Europe%2FZurich')
