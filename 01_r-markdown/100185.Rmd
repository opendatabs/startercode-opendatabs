...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100185)

Auto generated R starter code for data set 100185.
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100185.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100185/download?format=csv&timezone=Europe%2FZurich')
