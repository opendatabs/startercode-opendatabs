...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100056)

Auto generated R starter code for data set 100056.
...
- **Issued** `2019-12-02`
- **Modified** `2024-07-03T05:04:00+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100056.csv')
