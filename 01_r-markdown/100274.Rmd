...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100274)

Auto generated R starter code for data set 100274.
...
- **Issued** `2023-10-09`
- **Modified** `2024-06-05T13:30:12+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100274.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100274/download?format=csv&timezone=Europe%2FZurich')
