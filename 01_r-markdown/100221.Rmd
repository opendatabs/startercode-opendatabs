...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100221)

Auto generated R starter code for data set 100221.
...
- **Issued** `2025-02-10`
- **Modified** `2026-03-19T02:01:46+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100221.csv')
