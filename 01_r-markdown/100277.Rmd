...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100277)

Auto generated R starter code for data set 100277.
...
- **Issued** `2023-12-19`
- **Modified** `2024-05-17T14:29:11+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100277.csv')
