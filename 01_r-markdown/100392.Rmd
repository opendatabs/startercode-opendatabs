...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100392)

Auto generated R starter code for data set 100392.
...
- **Issued** `2024-08-26`
- **Modified** `2024-08-30T07:08:33+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100392.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100392/download?format=csv&timezone=Europe%2FZurich')
