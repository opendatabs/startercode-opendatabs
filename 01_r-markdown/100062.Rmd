...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100062)

Auto generated R starter code for data set 100062.
...
- **Issued** `2020-03-12`
- **Modified** `2024-07-04T23:04:14+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100062.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100062/download?format=csv&timezone=Europe%2FZurich')
