...
## Dataset: Bewilligungen gemäss dem baselstädtischen Gesetz über öffentliche Ruhetage und Ladenöffnung

[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100424)

Auto generated R starter code for data set 100424.
...
- **Issued** `2026-03-16`
- **Modified** `2026-03-16T16:16:13+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100424.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100424/download?format=csv&timezone=Europe%2FZurich')
