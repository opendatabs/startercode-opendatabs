...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100430)

Auto generated R starter code for data set 100430.
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100430.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100430/download?format=csv&timezone=Europe%2FZurich')
