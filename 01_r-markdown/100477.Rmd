...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100477)

Auto generated R starter code for data set 100477.
...
- **Issued** `2025-10-03`
- **Modified** `2026-02-09T18:30:03+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100477.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100477/download?format=csv&timezone=Europe%2FZurich')
