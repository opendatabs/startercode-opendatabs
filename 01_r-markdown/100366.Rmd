...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100366)

Auto generated R starter code for data set 100366.
...
- **Issued** `2025-11-13`
- **Modified** `2026-01-23T01:06:35+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100366.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100366/download?format=csv&timezone=Europe%2FZurich')
