...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100059)

Auto generated R starter code for data set 100059.
...
- **Issued** `2020-03-12`
- **Modified** `2024-07-02T23:01:00+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100059.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100059/download?format=csv&timezone=Europe%2FZurich')
