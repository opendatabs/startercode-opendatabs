...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100080)

Auto generated R starter code for data set 100080.
...
- **Issued** `2024-10-09`
- **Modified** `2025-12-30T07:11:07+00:00`
- **Rights** `NonCommercialAllowed-CommercialAllowed-ReferenceRequired`
- **Temporal_coverage_start_date** `2019-10-17T22:00:00+00:00`
- **Temporal_coverage_end_date** `2025-12-16T23:00:00+00:00`
- **Themes** `['Verwaltung']`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100080.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100080/download?format=csv&timezone=Europe%2FZurich')
