...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100399)

Auto generated R starter code for data set 100399.
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100399.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100399/download?format=csv&timezone=Europe%2FZurich')
