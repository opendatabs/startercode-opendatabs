...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100355)

Auto generated R starter code for data set 100355.
...
- **Issued** `None`
- **Modified** `2025-12-18T08:28:33+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100355.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100355/download?format=csv&timezone=Europe%2FZurich')
