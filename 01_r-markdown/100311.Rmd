...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100311)

Auto generated R starter code for data set 100311.
...
- **Issued** `2023-09-28`
- **Modified** `2024-07-03T08:03:24+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100311.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100311/download?format=csv&timezone=Europe%2FZurich')
