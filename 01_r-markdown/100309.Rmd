...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100309)

Auto generated R starter code for data set 100309.
...
- **Issued** `2023-09-28`
- **Modified** `2024-07-01T08:02:52+00:00`
- **Rights** `NonCommercialAllowed-CommercialAllowed-ReferenceRequired`
- **Temporal_coverage_start_date** `None`
- **Temporal_coverage_end_date** `None`
- **Themes** `['Politik', 'Verwaltung']`
- **Keywords** `['Regierungsrat', 'Grosser Rat', 'Parlament', 'Interessensbindungen']`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100309.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100309/download?format=csv&timezone=Europe%2FZurich')
