...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100398)

Auto generated R starter code for data set 100398.
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100398.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100398/download?format=csv&timezone=Europe%2FZurich')
