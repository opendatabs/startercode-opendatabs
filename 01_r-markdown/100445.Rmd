...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100445)

Auto generated R starter code for data set 100445.
...
- **Issued** `2025-05-27`
- **Modified** `2026-02-14T15:01:10+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100445.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100445/download?format=csv&timezone=Europe%2FZurich')
