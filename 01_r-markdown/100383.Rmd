...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100383)

Auto generated R starter code for data set 100383.
...
<br> Sämtliche Datensätze zu dem Produkt "Solarkataster": <a href="https://data.bs.ch/explore/?q=tags=solarkataster" target="_blank">https://data.bs.ch/explore/?q=tags=solarkataster</a>
...
- **Issued** `2024-08-15`
- **Modified** `2024-09-04T05:15:30+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100383.csv')
