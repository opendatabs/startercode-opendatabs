...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100295)

Auto generated R starter code for data set 100295.
...
- **Issued** `2023-10-09`
- **Modified** `2024-06-05T13:30:10+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100295.csv')
