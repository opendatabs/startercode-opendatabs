...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100121)

Auto generated R starter code for data set 100121.
...
- **Issued** `2021-03-23`
- **Modified** `2024-06-05T06:38:38+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100121.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100121/download?format=csv&timezone=Europe%2FZurich')
