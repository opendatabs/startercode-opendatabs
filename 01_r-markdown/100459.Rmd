...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100459)

Auto generated R starter code for data set 100459.
...
- **Issued** `2025-04-28`
- **Modified** `2026-01-26T18:30:17+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100459.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100459/download?format=csv&timezone=Europe%2FZurich')
