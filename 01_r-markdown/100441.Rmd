...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100441.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100441/download?format=csv&timezone=Europe%2FZurich')
