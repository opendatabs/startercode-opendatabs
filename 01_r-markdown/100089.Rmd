...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100089)

Auto generated R starter code for data set 100089.
...
- **Issued** `2020-06-29`
- **Modified** `2024-07-04T12:00:07+00:00`
- **Rights** `NonCommercialAllowed-CommercialAllowed-ReferenceNotRequired`
- **Temporal_coverage_start_date** `2020-06-22T23:05:00+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100089.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100089/download?format=csv&timezone=Europe%2FZurich')
