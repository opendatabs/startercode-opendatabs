...
Auto generated R starter code for data set 100242.
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100242.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100242/download?format=csv&timezone=Europe%2FZurich')
