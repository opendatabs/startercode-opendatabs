...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100402)

Auto generated R starter code for data set 100402.
...
- **Issued** `2024-11-14`
- **Modified** `2024-11-16T18:30:41+00:00`
...
- **Reference** `http://www.geo.bs.ch/hochbauprojekte; https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/c7c91cac-f7c1-42c1-ae99-eb4352ecf439`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100402.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100402/download?format=csv&timezone=Europe%2FZurich')
