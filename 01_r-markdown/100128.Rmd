...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100128)

Auto generated R starter code for data set 100128.
...
- **Issued** `2021-03-25`
- **Modified** `2024-07-01T01:36:28+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100128.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100128/download?format=csv&timezone=Europe%2FZurich')
