...
## Dataset: Anzahl durch Wärmepumpen beheizte Gebäude

[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100519)

Auto generated R starter code for data set 100519.
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100519.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100519/download?format=csv&timezone=Europe%2FZurich')
