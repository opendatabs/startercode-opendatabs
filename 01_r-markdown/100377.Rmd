...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100377)

Auto generated R starter code for data set 100377.
...
- **Issued** `2024-12-20`
- **Modified** `2026-03-16T11:15:59+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100377.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100377/download?format=csv&timezone=Europe%2FZurich')
