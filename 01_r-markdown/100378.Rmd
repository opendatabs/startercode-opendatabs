...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100378)

Auto generated R starter code for data set 100378.
...
- **Issued** `2024-12-20`
- **Modified** `2025-09-15T16:30:48+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100378.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100378/download?format=csv&timezone=Europe%2FZurich')
