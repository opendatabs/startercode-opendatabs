...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100360)

Auto generated R starter code for data set 100360.

## Metadata

- **Dataset_identifier** `100360`
- **Title** `Resultate der Ersatzwahl Regierungsrat 7. April 2024 (2. Wahlgang)`
...
- **Issued** `2024-04-06`
- **Modified** `2024-04-07T14:18:21+00:00`
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100360.csv')
...
df <- get_dataset('https://data.bs.ch/explore/dataset/100360/download?format=csv&timezone=Europe%2FZurich')
