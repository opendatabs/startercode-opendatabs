...
[Direct data shop link for dataset](https://data.bs.ch/explore/dataset/100431)

Auto generated R starter code for data set 100431.
...
get_dataset <- function(url) {
  ...
  csv_path <- file.path(data_path , '100431.csv')
